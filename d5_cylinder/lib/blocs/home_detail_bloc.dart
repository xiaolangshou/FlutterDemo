...
class HomeDetailBloc extends BlocBase {
  IOWebSocketChannel channel;
  /*输出 websocket*/
  final _outwebsocket = StreamController<String>.broadcast();
  final String initData = websockethomeStr;
  Stream<String> get recvWebsocket => _outwebsocket.stream;

  HomeDetailBloc._() {
    channel = IOWebSocketChannel.connect("${websocketIP}:8766");
...
//      Stream streamData = Stream.fromFuture(loadCountryData());
  ...
  static HomeDetailBloc _instance;

  factory HomeDetailBloc() {
    _instance ??= HomeDetailBloc._();
    return _instance;
  }
