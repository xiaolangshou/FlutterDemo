...
class DeviceTaskBloc extends BlocBase {
  IOWebSocketChannel channel;
  /*输出 websocket*/
  final _outwebsocket = StreamController<String>.broadcast();
  final String initData = websocketDeviceTaskStr;
  Stream<String> get recvWebsocket => _outwebsocket.stream;

  DeviceTaskBloc._() {
    channel = IOWebSocketChannel.connect("${websocketIP}:8767");
...
//      Stream streamData = Stream.fromFuture(loadCountryData());
  ...
  static DeviceTaskBloc _instance;

  factory DeviceTaskBloc() {
    _instance ??= DeviceTaskBloc._();
    return _instance;
  }
