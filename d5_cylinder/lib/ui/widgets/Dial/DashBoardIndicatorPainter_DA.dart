...
class DashBoardIndicatorPainter_DA extends CustomPainter {
  final double speeds;
  double tableSpace;
...
//  final Picture pictureBackView;
  ...
  DashBoardIndicatorPainter_DA(this.speeds, this.tableSpace,
      this.pictureBackGround, this.pictureIndicator);

  @override
  void paint(Canvas canvas, Size size) {
    String text = speeds.toStringAsFixed(1);
    pointerValue = conversionCoordDAPosition(speeds);
...
//    textPainter.layout(minWidth: 60,maxWidth: 40);
  ...
  double conversionCoordDAPosition(double value) {
    double da = value / 3;
    return da;
  }
