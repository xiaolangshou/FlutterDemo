...
import 'package:d5_cylinder/Device/DeviceDetail/devicetask/device_task_detail_view.dart';
...
class DeviceTaskView extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return new DeviceTaskViewState();
  }
}

class DeviceTaskViewState extends State<DeviceTaskView>
          ...
          body: Scaffold(
            ...
            body: TabBarView(
                ...
                children: _tags.map((Choice choise) {
                  ...
                  return DevideTaskDetailView(choise.title,);
