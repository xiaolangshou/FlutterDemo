...
class LineProgressIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (valueProgress1 < 0.8 * valueMax1)
      {
        disPlayColor1 = nomalColors;
      }
    else{
      disPlayColor1 = alarmColors;
    }
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                        ...
                        value: valueProgress1/valueMax1,
                        /*精确模式，进度20%*/
                        valueColor:
                            new AlwaysStoppedAnimation<Color>(disPlayColor1),
                      ),
                    ),
                  ),
                  Container(
